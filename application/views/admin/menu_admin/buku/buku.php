                            ...
                            <tbody>
                                ...
                                <?php foreach ($buku as $bk) : ?>
                                    <tr>
                                        <td><?= $i++  ?></td>
                                        <td><?= $bk['Nama_buku'] ?></td>
                                        <td><?= substr($bk['ringkasan_buku'], 0, 80)  ?>.....</td>
                                        ...
                                        <td><a href="<?= base_url('admin/ubah_buku/' . $bk['id']) ?>"><button type="button" rel="tooltip" title="" class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral" data-original-title="Edit Task">
                                            ...
                                            <a href="<?= base_url('admin/hapus_buku/' . $bk['id']) ?>" onclick="return confirm('Anda Yakin Menghapus Buku Ini ?')"><button type="button" rel="tooltip" title="" class="btn btn-danger btn-round btn-icon btn-icon-mini btn-neutral" data-original-title="Remove">
