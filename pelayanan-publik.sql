...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Sep 2021 pada 09.19
...
CREATE TABLE `foto` (
  ...
  `url_4` varchar(100) NOT NULL,
  `url_5` varchar(100) NOT NULL,
  `url_6` varchar(100) NOT NULL,
  `url_7` varchar(100) NOT NULL,
  `url_8` varchar(100) NOT NULL,
  `judul` text NOT NULL,
...
INSERT INTO `foto` (`id`, `url`, `url_1`, `url_2`, `url_3`, `url_4`, `url_5`, `url_6`, `url_7`, `url_8`, `judul`, `deskripsi`, `tanggal`) VALUES
(1, '1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '6.jpg', '7.jpg', '8.jpg', '9.jpg', 'STOP STIGMA UNTUK PENYALAHGUNA NARKOBA', 'Stigma adalah ciri negatif yang menempel pada pribadi seseorang karena pengaruh lingkungannya.', '2021-08-28');
...
INSERT INTO `video` (`id`, `url`, `tanggal`, `deskripsi`) VALUES
(1, '1.mp4', '2021-08-28', 'Mari Dukung Mewujudkan Indonesia Bersinar.');
